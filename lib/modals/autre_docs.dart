...
class AutreDocs {
  ...
  @override
  String toString() {
    return 'AutreDocs(id: $id, path: $path, modele_id: $modele_id, modele_type: $modele_type, deleted: $deleted, reference: $reference, doc_id: $doc_id, created_at: $created_at, updated_at: $updated_at)';
  }
