...
class CPS {
  ...
  factory CPS.fromMap(Map<String, dynamic> map) {
    return CPS(
      id: map['id'] as int,
  ...
  factory CPS.fromJson(String source) =>
      CPS.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'CPS(id: $id, path: $path, modele_id: $modele_id, modele_type: $modele_type, deleted: $deleted, reference: $reference, doc_id: $doc_id, created_at: $created_at, updated_at: $updated_at)';
  }

  @override
  bool operator ==(covariant CPS other) {
