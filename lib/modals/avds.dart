...
class Avd {
  ...
  factory Avd.fromMap(Map<String, dynamic> map) {
    return Avd(
      id: map['id'] as int,
  ...
  factory Avd.fromJson(String source) =>
      Avd.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'Avd(id: $id, path: $path, modele_id: $modele_id, modele_type: $modele_type, deleted: $deleted, reference: $reference, doc_id: $doc_id, created_at: $created_at, updated_at: $updated_at)';
  }

  @override
  bool operator ==(covariant Avd other) {
