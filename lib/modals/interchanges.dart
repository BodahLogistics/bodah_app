...
class Interchanges {
  ...
  @override
  String toString() {
    return 'Interchanges(id: $id, path: $path, expedition_id: $expedition_id, deleted: $deleted, reference: $reference, doc_id: $doc_id, commentaire: $commentaire, created_at: $created_at, updated_at: $updated_at)';
  }
