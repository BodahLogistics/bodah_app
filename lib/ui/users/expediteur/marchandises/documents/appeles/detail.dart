...
class DetailAppele extends StatelessWidget {
  const DetailAppele({super.key, required this.id});
  final int id;
  ...
  Widget build(BuildContext context) {
    ...
    Appeles apele = function.apele(apeles, id);
    Expeditions expedition =
        function.expedition(expeditions, apele.expedition_id);
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    alignment: Alignment.centerLeft,
                    child: Text(
                      function.date(apele.created_at),
                      style: TextStyle(
                          fontFamily: "Poppins",
                          fontWeight: FontWeight.w300,
                          color: user.dark_mode == 1
