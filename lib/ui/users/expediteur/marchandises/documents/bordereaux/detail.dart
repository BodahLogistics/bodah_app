...
class DetailBordereau extends StatelessWidget {
  const DetailBordereau({super.key, required this.id});
  final int id;
  ...
  Widget build(BuildContext context) {
    ...
    BordereauLivraisons bordereau = function.bordereau(bordereaux, id);
    Expeditions expedition =
        function.expedition(expeditions, bordereau.expedition_id);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text(
          "Bordereaux de livraison du chargement",
          style: TextStyle(
              color: user.dark_mode == 1 ? MyColors.light : Colors.black,
              ...
              child: Column(
                children: [
                  Container(
                    ...
                    child: Text(
                      "Référence du bordereaux de livraison",
                      style: TextStyle(
                          fontFamily: "Poppins",
                          fontWeight: FontWeight.bold,
                          fontSize: 16,
