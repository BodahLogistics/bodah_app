...
class MesLtas extends StatelessWidget {
  const MesLtas({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    List<Lta> datas = api_provider.ltas;
    ...
    return Scaffold(
      ...
      body: datas.isEmpty
          ? Center(
              child: Text("Vous n'avez aucune LTA disponible",
