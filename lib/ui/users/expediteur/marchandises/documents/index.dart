                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            alignment: Alignment.center,
                            child: Text(
                              function.formatAmount(ordres.length.toDouble()) +
                                  " Ordres",
                              maxLines: 1,
                              overflow: TextOverflow.ellipsis,
                              style: TextStyle(
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            alignment: Alignment.center,
                            child: Text(
                              function.formatAmount(appeles.length.toDouble()) +
                                  " Appélés",
                              maxLines: 1,
                              overflow: TextOverflow.ellipsis,
                              style: TextStyle(
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            alignment: Alignment.center,
                            child: Text(
                              function.formatAmount(tdos.length.toDouble()) +
                                  " TDO",
                              maxLines: 1,
                              overflow: TextOverflow.ellipsis,
                              style: TextStyle(
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            alignment: Alignment.center,
                            child: Text(
                              function.formatAmount(vgms.length.toDouble()) +
                                  " VGM",
                              maxLines: 1,
                              overflow: TextOverflow.ellipsis,
                              style: TextStyle(
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            alignment: Alignment.center,
                            child: Text(
                              function.formatAmount(recus.length.toDouble()) +
                                  " Reçus",
                              maxLines: 1,
                              overflow: TextOverflow.ellipsis,
                              style: TextStyle(
