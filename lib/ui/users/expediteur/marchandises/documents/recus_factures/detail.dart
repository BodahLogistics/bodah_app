...
class DetailRecu extends StatelessWidget {
  const DetailRecu({super.key, required this.id});
  final int id;
  ...
  Widget build(BuildContext context) {
    ...
    Recus recu = function.recu(recus, id);
    Expeditions expedition =
        function.expedition(expeditions, recu.expedition_id);
              ...
              child: Row(
                ...
                children: [
                  ...
                  IconButton(
                      onPressed: () {
                        String url =
                            "https://test.bodah.bj/storage/" + recu.path;
