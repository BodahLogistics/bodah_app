...
class MesRecus extends StatefulWidget {
  const MesRecus({super.key});

  @override
  State<MesRecus> createState() => _MesRecusState();
}

class _MesRecusState extends State<MesRecus> {
  @override
  void initState() {
    super.initState();
    Provider.of<ApiProvider>(context, listen: false).InitRecus();
  }
                  ...
                  child: Padding(
                    ...
                    child: ListView.builder(
                      itemBuilder: (context, index) {
                        Recus recu = recus[index];
                        Expeditions expedition =
                            function.expedition(expeditions, recu.modele_id);
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: ListTile(
                                ...
                                title: Text(
                                  recu.reference + " " + marchandise.nom,
                                  maxLines: 1,
