...
class MesImportOrdres extends StatelessWidget {
  const MesImportOrdres({super.key});
              ...
              child: Padding(
                ...
                child: ListView.builder(
                  itemBuilder: (context, index) {
                    OrdreTransport data = datas[index];

                    List<Cargaison> cargaisons = [];
                    if (data.modele_type.contains("Import")) {
                      Import import = function.import(imports, data.modele_id);
                      cargaisons = function.data_cargaisons(
                          cargaison, import.id, "Import");
                    } else {
                      Exports export = function.export(exports, data.modele_id);
                      cargaisons = function.data_cargaisons(
