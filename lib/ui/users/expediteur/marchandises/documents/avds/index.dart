...
class MesAvds extends StatelessWidget {
  const MesAvds({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    List<Avd> datas = api_provider.avds;
    ...
    return Scaffold(
      ...
      body: datas.isEmpty
          ? Center(
              child: Text("Vous n'avez aucun AVD disponible",
