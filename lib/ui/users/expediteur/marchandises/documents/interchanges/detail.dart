...
class DetailInterchange extends StatelessWidget {
  const DetailInterchange({super.key, required this.id});
  final int id;
  ...
  Widget build(BuildContext context) {
    ...
    Interchanges interchange = function.interchange(interchanges, id);
    Expeditions expedition =
        function.expedition(expeditions, interchange.expedition_id);
              ...
              child: Row(
                ...
                children: [
                  ...
                  IconButton(
                      onPressed: () {
                        String url =
                            "https://test.bodah.bj/storage/" + interchange.path;
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    alignment: Alignment.centerLeft,
                    child: Text(
                      function.date(interchange.created_at),
                      style: TextStyle(
                          fontFamily: "Poppins",
                          fontWeight: FontWeight.w300,
                          color: user.dark_mode == 1
