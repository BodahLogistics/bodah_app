...
import 'package:bodah/ui/users/expediteur/marchandises/documents/interchanges/detail.dart';
...
class MesInterchanges extends StatefulWidget {
  const MesInterchanges({super.key});

  @override
  State<MesInterchanges> createState() => _MesInterchangesState();
}

class _MesInterchangesState extends State<MesInterchanges> {
  @override
  void initState() {
    super.initState();
                  ...
                  child: Padding(
                    ...
                    child: ListView.builder(
                      itemBuilder: (context, index) {
                        Interchanges interchange = interchanges[index];
                        Expeditions expedition = function.expedition(
                            expeditions, interchange.expedition_id);
