...
class MesFiches extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<FicheTechnique> datas = api_provider.fiche_techniques;
    ...
    return Scaffold(
      ...
      body: datas.isEmpty
          ? Center(
              child: Text("Vous n'avez aucune fiche technique disponible",
              ...
              child: Padding(
                ...
                child: ListView.builder(
                  itemBuilder: (context, index) {
                    FicheTechnique data = datas[index];
