...
class DetailVgm extends StatelessWidget {
  const DetailVgm({super.key, required this.id});
  final int id;
              ...
              child: Row(
                ...
                children: [
                  ...
                  IconButton(
                      onPressed: () {
                        String url =
                            "https://test.bodah.bj/storage/" + vgm.path;
