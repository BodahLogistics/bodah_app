...
class DetailTdo extends StatelessWidget {
  const DetailTdo({super.key, required this.id});
  final int id;
              ...
              child: Row(
                ...
                children: [
                  ...
                  IconButton(
                      onPressed: () {
                        String url =
                            "https://test.bodah.bj/storage/" + tdo.path;
