...
class ChargTdo extends StatelessWidget {
  const ChargTdo({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    List<Tdos> datas = api_provider.tdos;
    ...
    Future<void> refresh() async {
      await api_provider.InitTransporteurTdo();
    }
    ...
    return Scaffold(
      ...
      body: datas.isEmpty
          ? RefreshIndicator(
              ...
              onRefresh: refresh,
              child: Center(
                  child: Text("Vous n'avez aucun TDO disponible",
