...
class LocationChargement extends StatefulWidget {
  LocationChargement({super.key, required this.chargement_id});
  final int chargement_id;

  @override
  State<LocationChargement> createState() => _LocationChargementState();
}

class _LocationChargementState extends State<LocationChargement> {
  @override
  @override
  void initState() {
    super.initState();
    Provider.of<ApiProvider>(context, listen: false).InitTransporteurGps();
  }
